...
abstract class DbCore
{
     ...
     * @param array $data Data to insert as associative array. If $data is a list of arrays, multiple insert will be
     *     done
    ...
    public function insert($table, $data, $null_values = false, $use_cache = true, $type = Db::INSERT, $add_prefix = true)
    {
        ...
        } else if ($type == Db::ON_DUPLICATE_KEY) {
            $insert_keyword = 'INSERT';
        } else {
     ...
     * @param bool $array Return an array instead of a result object (deprecated since 1.5.0.1, use query method
     *     instead)
     * @param bool $use_cache
     *
